...
import (
	...
	"github.com/hero1s/gotools/helper"
...
func (c *QiJinClient) UserCreation(user UserCreation) (UserCreationResponse, error) {
	body, err := c.postDataHttps(methodUrl_userCreation, common.ChangeStructToJsonMap(user))
...
func (c *QiJinClient) OrderCreation(order OrderCreation) (OrderCreationResponse, error) {
	body, err := c.postDataHttps(methodUrl_orderCreation, common.ChangeStructToJsonMap(order))
...
func (c *QiJinClient) OrderDetail(order OrderDetail) (OrderDetailResponse, error) {
	body, err := c.postDataHttps(methodUrl_orderDetail, common.ChangeStructToJsonMap(order))
